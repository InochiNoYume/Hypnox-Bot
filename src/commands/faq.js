...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      if (!channel?.isTextBased()) return interaction.editReply({ content: 'Configura OFFICIAL_CHANNEL_FAQ_ID en el entorno del bot.' });
      ...
      return interaction.editReply({ content: `Preguntas frecuentes publicadas en <#${channel.id}>.` });
    } catch (error) {
      console.error('[HYPNOX] FAQ error:', error);
